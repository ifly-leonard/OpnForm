    ...
    <div class="grid md:grid-cols-3 my-8">
      <div class="flex mt-2">
        <p class="text-sm text-gray-600 dark:text-gray-400 text-center w-full">
          icrewsystems © Copyright 2022. All Rights Reserved
        </p>
      </div>
      ...
      <ul class="flex justify-center mt-5 md:mt-1">
          <li class="mr-10">
            <a href="https://icrewsystems.com/policies/privacy" target="_blank" class="text-gray-600 dark:text-gray-400 transition-colors duration-300 hover:text-nt-blue">
              Privacy Policy
            </a>
          </li>
        </ul>
